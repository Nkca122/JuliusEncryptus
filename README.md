...
<p align = 'center'> 
A project to create an API which returns all possible combinations to a caesar cipher and sort them into recommended ones and non recommended ones to smoothline the vetting process. <b>We have also created a `Website`, `Mobile Application`, `Browser Extension` to display the API's prowess</b>
</p>
